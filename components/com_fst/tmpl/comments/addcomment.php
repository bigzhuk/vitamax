...
<?php endif; ?>
	...
	<?php /*if ($this->errors['body']): ?><tr><td></td><td class='fst_must_have_field'><?php echo $this->errors['body'] ?></td></tr><?php endif; */?>
		<tr>
			...
			<td colspan=1><textarea name='body' rows='5' cols='40' id='comment_body'><?php echo FST_Helper::escape($this->post['body']) ?></textarea></td>
			<?php if ($this->errors['body']): ?><td class='fst_must_have_field'><?php echo $this->errors['body'] ?></td><?php endif; ?>
		</tr>
		...
		<tr>
			<td></td>
			<td>
				<input type=submit value=' <?php echo $this->post_comment ?> ' id='addcomment' class='sppb-btn sppb-btn-success'>
			</td>
		</tr>
	</table>
	</form>
